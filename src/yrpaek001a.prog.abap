...
CLASS LCL_ALV DEFINITION INHERITING FROM ZCL_PAEK_CM_ALV.
    ...
    METHODS :
      ...
      EVENT_HOTSPOT
        IMPORTING I_ROW_ID    TYPE LVC_S_ROW
                  ...
                  SENDER      TYPE REF TO ZCL_PAEK_CM_OALV OPTIONAL,
     EVENT_HOTSPOT_TREE
        IMPORTING FIELDNAME TYPE LVC_FNAME
                  NODE_KEY  TYPE LVC_NKEY
                  SENDER      TYPE REF TO ZCL_PAEK_CM_OTREE OPTIONAL,
      EVENT_CHANGED
        IMPORTING
          ...
          SENDER          TYPE REF TO ZCL_PAEK_CM_OALV,
      EVENT_CHANGED_MENGE
        IMPORTING
          IR_DATA_CHANGED TYPE REF TO CL_ALV_CHANGED_DATA_PROTOCOL
...
CLASS LCL_ALV IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    FIELD-SYMBOLS <FS_EVENTLIST> TYPE ZCL_PAEK_CM_ALV_EVENT=>TY_EVENTLIST.
...
*        ME->MV_DYNNR = '0300'.
  ...
  METHOD SET_ALV_0100.
    ...
    TRY.
      ...
      CATCH ZCX_PAEK_EXCP INTO DATA(LO_ERROR).
