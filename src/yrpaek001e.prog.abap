...
CLASS LCL_EVENT_ALV DEFINITION.
  ...
  PUBLIC SECTION.
    CLASS-METHODS:
      HANDLE_TOOLBAR FOR EVENT TOOLBAR OF ZCL_PAEK_CM_OALV
        IMPORTING E_OBJECT E_INTERACTIVE SENDER,

      HANDLE_USER_COMMAND FOR EVENT USER_COMMAND OF ZCL_PAEK_CM_OALV
        IMPORTING E_UCOMM SENDER,

      HANDLE_DATA_CHANGED FOR EVENT DATA_CHANGED OF ZCL_PAEK_CM_OALV
      ...
      HANDLE_HOTSPOT_CLICK FOR EVENT HOTSPOT_CLICK OF ZCL_PAEK_CM_OALV
        IMPORTING E_ROW_ID E_COLUMN_ID ES_ROW_NO SENDER,

      HANDLE_DOUBLE_CLICK FOR EVENT DOUBLE_CLICK OF ZCL_PAEK_CM_OALV
