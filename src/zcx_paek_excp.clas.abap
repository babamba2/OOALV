class ZCX_PAEK_EXCP definition
  public
...
CLASS ZCX_PAEK_EXCP IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_PAEK_EXCP .
else.
  ...
  ELSE.
    ls_msg-msgid = ZCX_PAEK_EXCP-MSGID.
    ls_msg-msgno = ZCX_PAEK_EXCP-msgno.
    ls_msg-ATTR1 = ls_string-part1.
    ls_msg-ATTR2 = ls_string-part2.
    ls_msg-ATTR3 = ls_string-part3.
    ls_msg-ATTR4 = ls_string-part4.
